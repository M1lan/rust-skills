...
1. *Code example**: maintain English (because the code is in English)
2. *Note in Chinese: The terminology is indicated in parentheses
 - "Borrow Checker"
 - ✅ "Send trait"
3. * First appearance**: CE
4. * Follow-up**: uniform use of one language
5. * Terminology**: maintain English (e.g. , , )
